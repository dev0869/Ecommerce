    ...
    return (
        <>
            <div class="screen flex-center">
                <form class="popup flex p-lg" onSubmit={handleSubmit}>
                    ...
                    <div class="flex-fill flex-vertical">
                        <div class="header flex-between flex-vertical-center">
                            <div class="flex-vertical-center">
                                <span class="title">
                                    <strong>DevMart</strong><span>Pay</span>
                                </span>
                            </div>
                        ...
                        <div class="card-data flex-fill flex-vertical">
                            ...
                            <div class="flex-between">
                                <div class="card-number flex-vertical-center flex-fill">
                                    <div class="card-number-field flex-vertical-center flex-fill">
                                        ...
                                        <input class="numbers" type="number" min="1" max="9999" placeholder="0000" value={cardNumber} onChange={(e) => setCardNumber(e.target.value)} />
                                        <input class="numbers" type="number" min="1" max="9999" placeholder="0000" value={cardNumber2} onChange={(e) => setCardNumber2(e.target.value)} />-
                                        <input class="numbers" type="number" min="1" max="9999" placeholder="0000" value={cardNumber3} onChange={(e) => setCardNumber3(e.target.value)} />-
                                        <input class="numbers" type="number" min="1" max="9999" placeholder="0000" value={cardNumber4} onChange={(e) => setCardNumber4(e.target.value)} data-bound="carddigits_mock" data-def="0000" />
                                    </div>
                            ...
                            <div class="flex-between">
                                ...
                                <div class="card-property-value flex-vertical-center">
                                    <div class="input-container half-width">
                                        <input class="numbers" data-bound="mm_mock" data-def="00" type="number" min="1" max="12" step="1" placeholder="MM" value={expiryMonth} onChange={(e) => setExpiryMonth(e.target.value)} />
                                    </div>
                                    <span class="m-md">/</span>
                                    <div class="input-container half-width">
                                        <input class="numbers" data-bound="yy_mock" data-def="01" type="number" min="23" max="99" step="1" placeholder="YY" value={expiryYear} onChange={(e) => setExpiryYear(e.target.value)} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex-between">
                                ...
                                <div class="card-property-value">
                                    <div class="input-container">
                                        <input id="cvc" type="password" value={cvv} onChange={() => setCvv(true)} />
                            ...
                            <div class="flex-between">
                                ...
                                <div class="card-property-value">
                                    <div class="input-container">
                                        <input id="name" data-bound="name_mock" data-def="Mr. Cardholder" type="text" class="uppercase" placeholder="CARDHOLDER NAME" onChange={(e) => setCardName(e.target.value)} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="action flex-center">
                            <button type="submit" class="b-main-color pointer" > {isLoading ? 'Loading...' : 'Pay Now'}</button>
                        </div>
                    </div>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="purchase-section flex-fill flex-vertical">
                            ...
                            <div class="card-mockup flex-vertical">
                                <div class="flex-fill flex-between">
                                    <img src={user.photoURL} alt="" width={'90%'} height={'90%'} style={{ display: 'flex', margin: '0px auto', border: '0px solid', borderRadius: '10px' }} />
                                </div>
                                <div>
                                    <div id="name_mock" class="size-md pb-sm uppercase ellipsis">
                                        mr. {user.displayName} </div>
                                    <div class="size-md pb-md">
                                        <strong>
                                            <span class="pr-sm">
                                                &#x2022;&#x2022;&#x2022;&#x2022; &#x2022;&#x2022;&#x2022;&#x2022; &#x2022;&#x2022;&#x2022;&#x2022;
                                            </span>
                                            <span id="carddigits_mock">{cardNumber4}</span>
                                        </strong>
                                    </div>
                                    <div class="flex-between flex-vertical-center">
                            ...
                            <ul class="purchase-props">
                                <li class="flex-between">
                                    <span>SubTotal</span>
                                    <strong>{numberFormat(data)}</strong>
                                </li>
                                <li class="flex-between">
                                    <span>Tax</span>
                                    <strong>{numberFormat(20.60)}</strong>
                                </li>
                                <li class="flex-between">
                                    <span>Shipping</span>
                                    <strong>{numberFormat(100.00)}</strong>
                                </li>
                        ...
                        <div class="total-section flex-between flex-vertical-center">
                            <div class="flex-fill flex-vertical">
                                ...
                                <div>
                                    <strong>{numberFormat(data + 20.60 + 100)}</strong>
                                </div>
                            </div>
